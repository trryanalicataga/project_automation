...
public class SL_StudentProfileUpdatePageObject extends ObjectReference {
	...
	public void editDetails() throws InterruptedException {
		Thread.sleep(5000);
		Assert.assertTrue("UNAVAILABLE First Name field",elementUtil.isElementAvailabe(dev_SL_PROFILE_FIRSTNAME));
		...
		elementUtil.isClickedElementAvailable(dev_SL_PROFILE_TRAVELALONE);
		logger.info("Travel alone has been updated.");
		
//		Assert.assertTrue("Unable to sex change.",elementUtil.isClickedElementAvailable(dev_SL_PROFILE_GENDER));
//		logger.info("Gender has been updated.");
		
		WebElement element22 = driver.findElement(By.xpath(dev_SL_PROFILE_MOSTRECENTPROGRAM));
...
//		elementUtil.isClickedElementAvailable(dev_SL_PROFILE_MOSTRECENTPROGRAM);
//		Thread.sleep(2000);
